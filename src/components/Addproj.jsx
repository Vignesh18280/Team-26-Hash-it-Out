    ...
    <div className="mb-10 mt-5 ">
        ...
        <div className="mt-4 flex items-center justify-center">
            <div className="flex-col bg-slate-800 border basis-3/4 rounded-md border-white">
                ...
                <div className="flex px-2 mt-4 h-10 flex-wrap">
                    <h1 className="text-white text-2xl items-start">Category : </h1>
                    <input className='mx-12 flex-auto px-3 rows-3 rounded-md bg-slate-200' value={catg} onChange={(e) => {setcatg(e.target.value)}} type="text" placeholder="Description"/>
                </div>
